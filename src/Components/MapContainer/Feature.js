...
//         <div>
//           <label>Area:</label>
//           <input type="number" value={areaFilter} onChange={handleFilterChange} />
//           <select onChange={handleConditionChangeArea}>
...
//           <input type="number" value={shapeLengthFilter} onChange={handleShapeLengthFilterChange} />
//           <select onChange={handleConditionChangeShapeLength}>
//             <option value=">">greater</option>
//             <option value="<">lesser</option>
//             <option value="=">=</option>
...
//         </div>
//         <div>
//           <label>Target FID:</label>
//           <input type="number" value={targetFidFilter} onChange={handleTargetFidFilterChange} />
//           <select onChange={handleConditionChangeTargetFid}>
//             <option value=">">greater</option>
//             <option value="<">lesser</option>
//             <option value="=">=</option>
